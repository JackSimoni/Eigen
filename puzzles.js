const PUZZLES = [
  {
    ...
    clues: [
      ...
      { equation: String.raw`f(x)=\sum_{n=0}^{\infty}\frac{f^{(n)}(a)}{n!}(x-a)^n`, answer: "taylor expansion", aliases: ["taylor expansion","taylor series","taylors expansion","taylor's expansion","power series expansion"], hint: "Name this representation of a function using its derivatives at a point.", explanation: "This is the Taylor expansion of f about x = a." }
    ]
  },
  {
